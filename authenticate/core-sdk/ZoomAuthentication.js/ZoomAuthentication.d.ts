...
import { ZoomCustomization, ZoomOvalCustomization, ZoomCancelButtonCustomization, ZoomFeedbackBarCustomization, ZoomFrameCustomization, ZoomExitAnimationCustomization, ZoomSessionTimerCustomization, ZoomExitAnimationStyle, ZoomCancelButtonLocation, ZoomCameraPermissionsLaunchAction, ZoomOverlayCustomization, ZoomGuidanceCustomization, ZoomResultScreenCustomization, ZoomEnterFullScreenCustomization } from "./ZoomCustomization";
import { ZoomLoggingMode } from "./ZoomLogging";
import { ZoomFaceMapProcessor, ZoomFaceMapResultCallback, ZoomSessionStatus, ZoomPreloadResult, ZoomIDScanStatus, ZoomIDScanProcessor, ZoomIDScanResultCallback, ZoomSDKStatus, ZoomIDScanRetryMode, ZoomIDScanResult, ZoomSessionResult, ZoomIDScanNextStep } from "./ZoomPublicApi";
import { ZoomSession, ZoomSessionFromIFrame } from "./ZoomSession";
...
export { ZoomIDScanStatus, ZoomIDScanProcessor, ZoomIDScanResult, ZoomIDScanResultCallback, ZoomIDScanRetryMode, ZoomIDScanNextStep };
...
export declare var ZoomSDK: {
    ...
    **/
    ...
    /**
      * Core function calls that create and launch the ZoOm Interface in an IFrame.
    **/
    ZoomSessionFromIFrame: typeof ZoomSessionFromIFrame;
    /**
    ...
    **/
    ...
    /**
      * ZoOm ID Scan process behavior on starting.
    ...
    **/
    ZoomIDScanNextStep: typeof ZoomIDScanNextStep;
    /**
   ...
   **/
    ...
    **/
    ...
    /**
      * Return the ZoomSDK Result customization object
    **/
    ZoomEnterFullScreenCustomization: typeof ZoomEnterFullScreenCustomization;
    /**
    ...
    **/
    ...
    /**
      * Return the available ZoomSDK camera permissions screen launch actions
    **/

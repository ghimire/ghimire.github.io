...
export interface SessionTimerCustomization {
    /**
    * @deprecated Note: This customization property is deprecated and will be removed in an upcoming version of the Browser SDK. Use ZoomSessionTimerCustomization.livenessCheckNoInteractionTimeout.
    */
    maxTimeOverall: number;
    /**
    * @deprecated Note: This customization property is deprecated and will be removed in an upcoming version of the Browser SDK.
    */
...
export declare class ZoomCustomization {
    ...
    */
    ...
    [key: string]: {
        key: string;
    }[] | boolean | ZoomEnterFullScreenCustomization | ZoomIDScanCustomization | ZoomOvalCustomization | ZoomFeedbackBarCustomization | ZoomFrameCustomization | ZoomExitAnimationCustomization | ZoomCancelButtonCustomization | ZoomSessionTimerCustomization | ZoomInitialLoadingAnimationCustomization | ZoomGuidanceCustomization | ZoomOverlayCustomization | ZoomResultScreenCustomization | string;
}
/**
 * Customize the time after which the ZoOm Session should timeout.
 */
export declare class ZoomSessionTimerCustomization implements SessionTimerCustomization {
    ...
    */
    maxTimeOverall: number;
    /**
    * @deprecated Note: This customization class is deprecated and will be removed in an upcoming version of the Browser SDK.
    */
    maxTimeToDetectFirstFace: number;
    /**
    * @deprecated Note: This customization class is deprecated and will be removed in an upcoming version of the Browser SDK.
    */
     ...
     * The default value is -1, falling back to using the value configured with the deprecated propery ZoomSessionTimerCustomization.maxTimerOverall, which has a default value of 60 (seconds).
     */
    livenessCheckNoInteractionTimeout: number;
    /**
...
export declare class ZoomGuidanceCustomization implements GuidanceCustomization {
     ...
     * When configured to a non-empty array, these images will override the single image configured for ZoomGuidanceCustomization.retryScreenIdealZoomImage.

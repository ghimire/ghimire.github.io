...
var LivenessCheckProcessor = /** @class */ (function () {
    function LivenessCheckProcessor(onComplete, onSessionTokenError) {
    ...
    LivenessCheckProcessor.prototype.processZoomSessionResultWhileZoomWaits = function (zoomSessionResult, zoomFaceMapResultCallback) {
        var _this = this;
        ...
        NetworkingHelpers.getLivenessCheckResponseFromZoomServer(zoomSessionResult, zoomFaceMapResultCallback, function (nextStep) {
            _this.latestZoomSessionResult = zoomSessionResult;
            _this.zoomFaceMapResultCallback = zoomFaceMapResultCallback;
